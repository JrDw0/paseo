...
export const ru: TranslationResources = {
  ...
  modelSelector: {
    ...
    shortcutDisabled: "Этот агент сейчас не может сменить модель",
    shortcutLoading: "Модели ещё загружаются",
    shortcutProviderError:
      "Не удалось загрузить список моделей — откройте выбор модели и повторите",
    shortcutUnavailable: "Нет доступных моделей для переключения",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        pickModelByNumber: "Выбрать модель по номеру",
