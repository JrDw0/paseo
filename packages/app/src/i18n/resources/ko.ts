...
export const ko: TranslationResources = {
  ...
  modelSelector: {
    ...
    loading: "불러오는 중...",
    loadingShort: "불러오는 중",
    shortcutDisabled: "이 에이전트는 지금 모델을 변경할 수 없습니다",
    shortcutLoading: "모델을 불러오는 중입니다",
    shortcutProviderError: "모델 목록을 불러오지 못했습니다 — 모델 선택을 열어 다시 시도하세요",
    shortcutUnavailable: "전환할 수 있는 모델이 없습니다",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        openModelPicker: "모델 전환",
        pickModelByNumber: "숫자로 모델 선택",
