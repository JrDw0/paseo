...
export const fr: TranslationResources = {
  ...
  modelSelector: {
    ...
    shortcutDisabled: "Cet agent ne peut pas changer de modèle pour le moment",
    shortcutLoading: "Les modèles sont encore en cours de chargement",
    shortcutProviderError:
      "Échec du chargement de la liste des modèles — ouvrez le sélecteur de modèles pour réessayer",
    shortcutUnavailable: "Aucun modèle disponible vers lequel basculer",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        pickModelByNumber: "Choisir un modèle par numéro",
