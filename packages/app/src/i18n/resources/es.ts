...
export const es: TranslationResources = {
  ...
  modelSelector: {
    ...
    shortcutDisabled: "Este agente no puede cambiar de modelo ahora",
    shortcutLoading: "Los modelos aún se están cargando",
    shortcutProviderError:
      "No se pudo cargar la lista de modelos: abre el selector de modelos para reintentar",
    shortcutUnavailable: "No hay modelos disponibles a los que cambiar",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        pickModelByNumber: "Elegir modelo por número",
