...
export const ptBR: TranslationResources = {
  ...
  modelSelector: {
    ...
    shortcutDisabled: "Este agente não pode mudar de modelo agora",
    shortcutLoading: "Os modelos ainda estão carregando",
    shortcutProviderError:
      "Falha ao carregar a lista de modelos — abra o seletor de modelos para tentar de novo",
    shortcutUnavailable: "Nenhum modelo disponível para alternar",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        openModelPicker: "Alternar modelo",
        pickModelByNumber: "Escolher modelo pelo número",
