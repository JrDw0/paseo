...
export const zhCN: TranslationResources = {
  ...
  modelSelector: {
    ...
    loading: "正在加载...",
    loadingShort: "正在加载",
    shortcutDisabled: "当前代理暂时不能切换模型",
    shortcutLoading: "模型列表仍在加载",
    shortcutProviderError: "模型列表加载失败 —— 打开模型选择器重试",
    shortcutUnavailable: "没有可切换的模型",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        openModelPicker: "切换模型",
        pickModelByNumber: "按数字选择模型",
