...
export const ar: TranslationResources = {
  ...
  modelSelector: {
    ...
    loading: "تحميل...",
    loadingShort: "تحميل",
    shortcutDisabled: "لا يمكن لهذا الوكيل تغيير النموذج الآن",
    shortcutLoading: "النماذج لا تزال تُحمّل",
    shortcutProviderError: "تعذّر تحميل قائمة النماذج — افتح محدد النموذج لإعادة المحاولة",
    shortcutUnavailable: "لا توجد نماذج للتبديل إليها",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        openModelPicker: "تبديل النموذج",
        pickModelByNumber: "اختيار النموذج بالرقم",
