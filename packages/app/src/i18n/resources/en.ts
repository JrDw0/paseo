export const en = {
  ...
  modelSelector: {
    ...
    shortcutDisabled: "This agent can't change models right now",
    shortcutLoading: "Models are still loading",
    shortcutProviderError: "Model list failed to load — open the model selector to retry",
    shortcutUnavailable: "No models available to switch to",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        openModelPicker: "Switch model",
        pickModelByNumber: "Pick model by number",
