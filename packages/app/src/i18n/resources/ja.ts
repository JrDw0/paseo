...
export const ja: TranslationResources = {
  ...
  modelSelector: {
    ...
    loading: "読み込み中...",
    loadingShort: "読み込み中",
    shortcutDisabled: "このエージェントは今モデルを変更できません",
    shortcutLoading: "モデルを読み込み中です",
    shortcutProviderError:
      "モデル一覧の読み込みに失敗しました — モデル選択を開いて再試行してください",
    shortcutUnavailable: "切り替えできるモデルがありません",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        openModelPicker: "モデルを切り替え",
        pickModelByNumber: "数字でモデルを選択",
